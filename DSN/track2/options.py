...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--kernel_path', type=str, default='/home/tangjingzhu/Works/Real-SR/_Experiments/DSN_ADL/kernel_results', help='kernel_path')
        ...
        ## data loss related
        self.parser.add_argument('--data_loss_type', type=str, choices=('bic', 'avg', 'gau', 'avg_bic', 'gau_bic', 'wavelet_bic', 'kl_gau_bic', 'kl_gau_ker', 'kl_grad_bic'), default='kl_gau_bic', help='type of available data type')
        # bic
        # avg
        ...
        self.parser.add_argument('--perceptual_loss', type=str, choices=('LPIPS', 'VGG', 'VGG19', 'VGG19_Per'), default='LPIPS', help='option for use_perceptual_loss')
