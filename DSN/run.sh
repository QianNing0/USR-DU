...
## test
CUDA_VISIBLE_DEVICES=0 python track2/test_down_per_vgg19_l1.py --gen_model resnet_uncertainty_per_vgg19 --dis_model unet --dis_inc 3 --name mile50_100_track2_resnet_uncertainty_unet_kl_gau_ker_per_vgg19_l1_ep175 --resume_down /home/tangjingzhu/Works/Real-SR/_Experiments/DSN_ADL/experiments/mile50_100_track2_resnet_uncertainty_unet_kl_gau_ker_per_vgg19_l1/models/training_down_0175.pth --valid_source DPEDiphone_train_y --test_dataroot /home/tangjingzhu/Works/Dataset/NITRE2020/Track2/ --nobin
